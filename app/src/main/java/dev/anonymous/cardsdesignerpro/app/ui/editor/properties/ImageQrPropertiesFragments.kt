...
import dev.anonymous.cardsdesignerpro.app.databinding.FragmentPropImageBinding
import dev.anonymous.cardsdesignerpro.app.databinding.FragmentPropQrBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnChangeImage.setOnClickListener {
            ...
            if (e.imagePath.startsWith("pack:")) {
                val sheet = dev.anonymous.cardsdesignerpro.app.ui.editor.addelem.PackBrowserBottomSheet()
        ...
        parentFragmentManager.setFragmentResultListener(
            dev.anonymous.cardsdesignerpro.app.ui.editor.addelem.PackBrowserBottomSheet.RESULT_KEY,
            viewLifecycleOwner
        ) { _, bundle ->
            val packPath = bundle.getString(
                dev.anonymous.cardsdesignerpro.app.ui.editor.addelem.PackBrowserBottomSheet.KEY_PACK_PATH
            ) ?: return@setFragmentResultListener
...
class QrPropertiesFragment : Fragment(), PropertyFragment {
    ...
    private fun populateFrom(el: TemplateElement.QrElement) {
        ...
        if (viewModel.currentTemplate.credentialMode == dev.anonymous.cardsdesignerpro.app.data.model.CredentialMode.SHORT) {
