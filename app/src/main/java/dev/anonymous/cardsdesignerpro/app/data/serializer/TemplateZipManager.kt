package dev.anonymous.cardsdesignerpro.app.data.serializer
...
object TemplateZipManager {
    ...
    private fun collectLocalPaths(template: Template): Set<String> {
        ...
        fun collect(elements: List<dev.anonymous.cardsdesignerpro.app.data.model.TemplateElement>) {
            elements.forEach { el ->
                when (el) {
                    ...
                    is dev.anonymous.cardsdesignerpro.app.data.model.TemplateElement.QrElement ->
    ...
    private fun rewriteImagePaths(template: Template, imageDir: String): Template {
        ...
        fun rewriteElements(elements: List<dev.anonymous.cardsdesignerpro.app.data.model.TemplateElement>) =
            elements.map { el ->
                when (el) {
                    is dev.anonymous.cardsdesignerpro.app.data.model.TemplateElement.ImageElement ->
