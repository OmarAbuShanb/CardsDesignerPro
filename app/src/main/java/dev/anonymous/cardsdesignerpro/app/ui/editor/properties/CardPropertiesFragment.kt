...
import dev.anonymous.cardsdesignerpro.app.databinding.FragmentPropCardBinding
...
class CardPropertiesFragment : Fragment(), PropertyFragment {
    ...
    private fun populate(card: dev.anonymous.cardsdesignerpro.app.data.model.CardStyle) {
        updating = true
