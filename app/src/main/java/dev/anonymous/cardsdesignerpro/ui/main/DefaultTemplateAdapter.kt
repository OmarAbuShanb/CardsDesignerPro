...
class DefaultTemplateAdapter(
    ...
    inner class VH(val binding: ItemTemplateBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Pair<String, Template>) {
            ...
            val starRes = if (!template.isFree) dev.anonymous.cardsdesignerpro.R.drawable.ic_premium_star else 0
            ...
            binding.cardContainer.setOnClickListener { onOpen(dirName, template) }
        }
    }
